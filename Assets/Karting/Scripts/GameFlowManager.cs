...
public class GameFlowManager : MonoBehaviour
{
	...
	public DisplayMessage newRecordDisplayMessage;
    ...
    void Start()
    {
		...
		newRecordDisplayMessage.gameObject.SetActive(false);

		DataManager.NewRecord += OnNewRecord;
	...
	{
		newRecordDisplayMessage.gameObject.SetActive(true);
	}
    ...
    void EndGame(bool win)
    {
        ...
        //Save game at the end
        m_TimeManager.SaveBetterTime();
